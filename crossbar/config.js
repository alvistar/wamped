System.config({
  ...
  bundles: {
    "app-build": [
      ...
      "npm:autobahn@0.9.8",
      "npm:autobahn@0.9.8/index",
      "npm:autobahn@0.9.8/lib/auth/cra",
      "npm:autobahn@0.9.8/lib/auth/persona",
      "npm:autobahn@0.9.8/lib/autobahn",
      "npm:autobahn@0.9.8/lib/configure",
      "npm:autobahn@0.9.8/lib/connection",
      "npm:autobahn@0.9.8/lib/log",
      "npm:autobahn@0.9.8/lib/polyfill",
      "npm:autobahn@0.9.8/lib/polyfill/array",
      "npm:autobahn@0.9.8/lib/polyfill/console",
      "npm:autobahn@0.9.8/lib/polyfill/function",
      "npm:autobahn@0.9.8/lib/polyfill/json",
      "npm:autobahn@0.9.8/lib/polyfill/object",
      "npm:autobahn@0.9.8/lib/polyfill/string",
      "npm:autobahn@0.9.8/lib/polyfill/typedarray",
      "npm:autobahn@0.9.8/lib/session",
      "npm:autobahn@0.9.8/lib/transport/longpoll",
      "npm:autobahn@0.9.8/lib/transport/rawsocket",
      "npm:autobahn@0.9.8/lib/transport/websocket",
      "npm:autobahn@0.9.8/lib/util",
      "npm:autobahn@0.9.8/package.json!github:systemjs/plugin-json@0.1.0",
      "npm:base64-js@0.0.8",
      "npm:base64-js@0.0.8/lib/b64",
      "npm:bootstrap-switch@3.3.2",
      "npm:bootstrap-switch@3.3.2/dist/js/bootstrap-switch",
      "npm:buffer@3.5.2",
      "npm:buffer@3.5.2/index",
      "npm:core-util-is@1.0.2",
      "npm:core-util-is@1.0.2/lib/util",
      "npm:crypto-js@3.1.5",
      "npm:crypto-js@3.1.5/aes",
      "npm:crypto-js@3.1.5/cipher-core",
      "npm:crypto-js@3.1.5/core",
      "npm:crypto-js@3.1.5/enc-base64",
      "npm:crypto-js@3.1.5/enc-utf16",
      "npm:crypto-js@3.1.5/evpkdf",
      "npm:crypto-js@3.1.5/format-hex",
      "npm:crypto-js@3.1.5/hmac",
      "npm:crypto-js@3.1.5/index",
      "npm:crypto-js@3.1.5/lib-typedarrays",
      "npm:crypto-js@3.1.5/md5",
      "npm:crypto-js@3.1.5/mode-cfb",
      "npm:crypto-js@3.1.5/mode-ctr",
      "npm:crypto-js@3.1.5/mode-ctr-gladman",
      "npm:crypto-js@3.1.5/mode-ecb",
      "npm:crypto-js@3.1.5/mode-ofb",
      "npm:crypto-js@3.1.5/pad-ansix923",
      "npm:crypto-js@3.1.5/pad-iso10126",
      "npm:crypto-js@3.1.5/pad-iso97971",
      "npm:crypto-js@3.1.5/pad-nopadding",
      "npm:crypto-js@3.1.5/pad-zeropadding",
      "npm:crypto-js@3.1.5/pbkdf2",
      "npm:crypto-js@3.1.5/rabbit",
      "npm:crypto-js@3.1.5/rabbit-legacy",
      "npm:crypto-js@3.1.5/rc4",
      "npm:crypto-js@3.1.5/ripemd160",
      "npm:crypto-js@3.1.5/sha1",
      "npm:crypto-js@3.1.5/sha224",
      "npm:crypto-js@3.1.5/sha256",
      "npm:crypto-js@3.1.5/sha3",
      "npm:crypto-js@3.1.5/sha384",
      "npm:crypto-js@3.1.5/sha512",
      "npm:crypto-js@3.1.5/tripledes",
      "npm:crypto-js@3.1.5/x64-core",
      "npm:events@1.0.2",
      ...
      "npm:when@3.7.5",
      "npm:when@3.7.5/function",
      "npm:when@3.7.5/lib/Promise",
      "npm:when@3.7.5/lib/Scheduler",
      "npm:when@3.7.5/lib/TimeoutError",
      "npm:when@3.7.5/lib/apply",
      "npm:when@3.7.5/lib/decorators/array",
      "npm:when@3.7.5/lib/decorators/flow",
      "npm:when@3.7.5/lib/decorators/fold",
      "npm:when@3.7.5/lib/decorators/inspect",
      "npm:when@3.7.5/lib/decorators/iterate",
      "npm:when@3.7.5/lib/decorators/progress",
      "npm:when@3.7.5/lib/decorators/timed",
      "npm:when@3.7.5/lib/decorators/unhandledRejection",
      "npm:when@3.7.5/lib/decorators/with",
      "npm:when@3.7.5/lib/env",
      "npm:when@3.7.5/lib/format",
      "npm:when@3.7.5/lib/liftAll",
      "npm:when@3.7.5/lib/makePromise",
      "npm:when@3.7.5/lib/state",
      "npm:when@3.7.5/monitor",
      "npm:when@3.7.5/monitor/ConsoleReporter",
      "npm:when@3.7.5/monitor/PromiseMonitor",
      "npm:when@3.7.5/monitor/console",
      "npm:when@3.7.5/monitor/error",
      "npm:when@3.7.5/when",
      "npm:ws@0.8.0",
      "npm:ws@0.8.0/lib/browser",
      "switchbutton",
      "switchbutton.html!github:systemjs/plugin-text@0.0.3"
    ],
    "aurelia": [
      ...
      "github:twbs/bootstrap@3.3.5/css/bootstrap.css!github:systemjs/plugin-text@0.0.3",
      ...
      "npm:aurelia-framework@1.0.0-beta.1/aurelia-framework",
